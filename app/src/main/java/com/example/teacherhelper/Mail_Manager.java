...
public class Mail_Manager {
    ...
    static String RECEIVER_NAME = "x1437367259@163.com";
    private static final String SENDER_NAME = "1437367259@qq.com";
    private static final String SENDER_PASS = "qulwmwwdqoylhbib";
...
//    String FROM_ADD = "1437367259@qq.com";
//    String FROM_PSW = "qulwmwwdqoylhbib";
//        String FROM_PSW = "hurymnyufzxljadi";

    public static Mail_Manager getInstance() {
    ...
    private static class InstanceHolder {
        private static Mail_Manager instance = new Mail_Manager();
    }
    ...
    public void sendMailWithFile(String title, String content, String filePath) {
        MimeMessage mimeMessage = createMessage(title, content);
        appendFile(mimeMessage, filePath);//添加附件
        MailTask mailTask = new MailTask(mimeMessage);
        mailTask.execute();
    }
    ...
    private MimeMessage createMessage(String title, String content) {
        ...
        properties.put(KEY_MAIL_HOST, VALUE_MAIL_HOST);//发件主机
        properties.put(KEY_MAIL_AUTH, VALUE_MAIL_AUTH);//收件主机
        //新建会话
